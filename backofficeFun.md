...
The new payment settlement is created.

If you click the Load button, a selection window pops up. Expend BackOffice -> Fee -> Book (e.g., InterestRate) -> Product (e.g., FiBond). All the bond 
trades having cash settlements within this book are displayed.
...
[OSF digital swap](https://osf.io/qzmer/download)
