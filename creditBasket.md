...
Calibration of this model may be a challenge given the number of correlated inputs and limited historical credit data (see https://finpricing.com/lib/IrBasisCurve.html). In this report we essentially test submitted inputs. In particular, we rely on the provided credit transition matrix and spread mean reverting parameters. On the other hand, we do investigate shocked scenarios as one way of assessing the sensitivity of the output to the supplied inputs.
